...
class FlutterSwitcherActivity : FlutterActivity() {
    ...
    companion object {
        ...
        fun withState(context: Context, state: String, stateCallBack: (result: HistoryEntry)-> Unit) : Intent{
