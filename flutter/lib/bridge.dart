...
class HistoryEntry {
  ...
  static HistoryEntry decode(Object message) {
    ...
    return HistoryEntry(
      state: (pigeonMap['state'] as HashMap<String,Object>),
    );
  }
}
  ...
  static void setup(FApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          assert(arg_state != null, 'Argument for dev.flutter.pigeon.FApi.currentState was null, expected non-null String.');
